...
public class SaleReturnActivity extends AppCompatActivity {
    ...
    void init() {
        ...
        back_image.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        SaleReturnActivity.super.onBackPressed();
                    }
                }
        );
        add_items_btn.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(SaleReturnActivity.this, CounterPosActivity.class));
                    }
                }
        );
