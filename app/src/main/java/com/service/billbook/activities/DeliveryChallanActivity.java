...
public class DeliveryChallanActivity extends AppCompatActivity {
    ...
    void init() {
        ...
        back_image.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        DeliveryChallanActivity.super.onBackPressed();
                    }
                }
        );
        add_items_btn.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(DeliveryChallanActivity.this, CounterPosActivity.class);
